	...
	function drawPointLabels(scale) {
		...
		for (var i = getValueCount(scale) - 1; i >= 0; i--) {
			...
			if (pointLabelOpts.display) {
				...
				//Sergio Nunes: Fix for allowing different color on point labels. assumes an array as big as the labels array
                var isColorArr = Object.prototype.toString.call(pointLabelOpts.fontColor) === '[object Array]';
                var pointLabelFontColor = getValueOrDefault(isColorArr?pointLabelOpts.fontColor[i]:pointLabelOpts.fontColor, globalDefaults.defaultFontColor);
